...
GITHUB_REMOTE=git@github.com:fnproject/fdk-ruby.git
BITBUCKET_REMOTE=ssh://git@bitbucket.oci.oraclecorp.com:7999/faas/fdk-ruby.git
PUBLISH_BRANCH=github
TARGET_BRANCH=master
GIT_USER_EMAIL=ci@fnproject.com
GIT_USER_NAME=CI
SSH_KEY_SECRET=ocid1.vaultsecret.oc1.phx.amaaaaaaepf6idiaxmjqv7ryywdzas26hz5uj427ta6bco57d5bz37hl5a2a
